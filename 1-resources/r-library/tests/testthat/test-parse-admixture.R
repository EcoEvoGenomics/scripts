...
test_that("Instantiator function returns identical output as direct instantiation", {
  inst_function <- parse_admixture("../testdata/test-admixture", paste("ID", seq(5)), "TestID")
  inst_direct <- admixture_parser$new("../testdata/test-admixture", paste("ID", seq(5)), "TestID")
